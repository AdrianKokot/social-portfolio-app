...
export const uiButtonVariantsConfig: { [key in uiButtonVariants]: string } = {
  ...
  primary: 'block w-full hover:bg-green-700 duration-300 transition-colors bg-green-600 loading:text-opacity-0 loading:bg-green-700 rounded-lg text-gray-50 font-medium  py-1 px-2  focus:bg-green-700',
  secondary: 'block w-full hover:bg-gray-300 duration-300 transition-colors bg-gray-200 loading:text-opacity-0 loading:bg-gray-300 rounded-lg text-gray-700 font-medium  py-1 px-2  focus:bg-gray-300'
}
