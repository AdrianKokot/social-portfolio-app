    ...
    public partial class AddEntities : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationUserDiscussion", x => new { x.SavedById, x.SavedDiscussionsId });
                    table.ForeignKey(
                        name: "FK_ApplicationUserDiscussion_AspNetUsers_SavedById",
                        column: x => x.SavedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ApplicationUserDiscussion_Discussions_SavedDiscussionsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationUserComment", x => new { x.SavedById, x.SavedCommentsId });
                    table.ForeignKey(
                        name: "FK_ApplicationUserComment_AspNetUsers_SavedById",
                        column: x => x.SavedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ApplicationUserComment_Comments_SavedCommentsId",
                        column: x => x.SavedCommentsId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationUserComment_SavedCommentsId",
                table: "ApplicationUserComment",
                column: "SavedCommentsId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationUserDiscussion_SavedDiscussionsId",
                table: "ApplicationUserDiscussion",
